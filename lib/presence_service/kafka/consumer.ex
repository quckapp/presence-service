defmodule PresenceService.Kafka.Consumer do
  @moduledoc """
  Kafka consumer for presence events from other services.
  ...
  - **Supervisor Pattern**: Proper OTP supervision with restart strategies
  ...
  # Valid presence statuses - prevents atom table exhaustion
  @valid_statuses ~w(online offline away busy invisible dnd)
  ...
  def init(_opts) do
    ...
    :ets.new(:kafka_dedup, [:set, :named_table, :public])
